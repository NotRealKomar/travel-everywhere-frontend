...
export const RouteDetails: React.FC = () => {
  ...
  const { waypoints, routeDetailsData, loadRouteDetailsData } =
    useRouteDetails();
  ...
  return routeDetailsData ? (
    <ContentWrapper>
      ...
      <Typography variant="subtitle2">
        {routeDetailsData.startDate} - {routeDetailsData.endDate}
      </Typography>
      {routeDetailsData.destinations.map((destination) => (
        <DestinationWrapper key={window.crypto.randomUUID()}>
          <Divider />
          <DestinationContentWrapper>
            {destination.title !== null && destination.city !== null ? (
              <>
                ...
                <Typography marginLeft="45px" variant="body1">
                  {destination.title}
                </Typography>
                <Typography marginLeft="45px" variant="subtitle2">
      ...
      <RouteMap
        isRouteDetails
        routeData={routeDetailsData.routeData}
        waypoints={waypoints}
      />
    </ContentWrapper>
  ) : (
