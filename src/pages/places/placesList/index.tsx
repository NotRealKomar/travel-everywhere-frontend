...
export const PlacesList: React.FC<PlacesListProps> = ({
  ...
  const { placesData, searchQuery, loadPlacesData, onSearchValueChange } =
  ...
  return placesData.length > 0 ? (
    <ListWrapper style={{ flexBasis: small ? '120px' : '100%' }}>
      {showTitle && (
        <TitleWrapper>
    ...
    <Box>
      ...
      <EmptyListWrapper>
        ...
        <Typography variant="h4">Нет созданных маркеров</Typography>
        <Typography
          variant="subtitle2"
          style={{ color: 'gray', margin: '24px' }}
        >
          Создайте новое место на карте через меню &quot;Места&quot; или по{' '}
          <u>ссылке</u>
        </Typography>
      </EmptyListWrapper>
    </Box>
