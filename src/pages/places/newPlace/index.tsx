...
export const NewPlace: React.FC = () => {
  ...
  const stepsElements: JSX.Element[] = [
    <>
      ...
      <FormControl sx={{ m: 1, minWidth: 120 }}>
        ...
        >
          ...
          <MenuItem value={CustomMarkerType.PERFECT_VIEW}>
            Perfect view
          </MenuItem>
    ...
    <>
      ...
      <AutocompleteField appendPoint={setPoint} />
    ...
    <>
      <Typography variant="caption">
        Впоследствии вы можете редактировать маркер на странице
        &quot;Места&quot;. Нажмите кнопку &quot;Создать маркер&quot; чтобы
        продолжить
      </Typography>
      <CheckBoxWrapper>
  ...
  return (
    <Box component="form" noValidate onSubmit={handleSavePlace}>
      <Typography variant="h4">Новый маркер</Typography>
